...
import { Component, EventEmitter, Inject, Input, OnDestroy, Output, SimpleChanges, OnChanges } from '@angular/core';
...
export class ExchangeOrderAttachmentsComponent implements OnDestroy, OnChanges {
