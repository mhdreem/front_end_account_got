        ...
        let Form = this.frmBuilder.group(
          {
            ...
            'snd_kid_stg_user_seq':  new FormControl<number | undefined>(undefined, []),        
            'snd_kid_stg_fk':  new FormControl<number | undefined>(undefined, []),        
          }
        );
        Form.controls['user_fk'].setValue(tempuser.user_seq);
        Form.controls['user'].setValue(tempuser);
        Form.controls['snd_kid_stg_user_seq'].setValue(null);
  ...
  getValue()
  {
    if (this.Form!= null )
    {
        ...
        if (this.snd_kid_stg_name.value!= null)
          ...
          if (this.snd_kid_stg_order.value!= null && (this.snd_kid_stg_order.value+ "") != "")
         ...
         if (users!= null && users.length>0)
         {
          ...
          this.selected_Sanad_kid_stage.sanad_kid_stage_users = selectedusers;
         } 
