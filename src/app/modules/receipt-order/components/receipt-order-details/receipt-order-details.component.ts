...
@Component({
  selector: 'app-receipt-order-details',
...
export class ReceiptOrderDetailsComponent implements OnDestroy,OnChanges{
  ...
  ngOnInit() {
    this.accounts_tree_fk.addAsyncValidators([validate_account_tree(this.PageReceiptOrderService, this.accounts_tree_fk.value)])
  }
      ...
      this.Form = this.fb.group(
        {
          ...
          'receipt_order_fk': this.receipt_order_fk = new FormControl<number | null>(null, [Validators.required]),
  ...
  public SetValue() {
    try {
      ...
      if (this.receipt_order_detail != null && this.receipt_order_detail?.seq != null)
        this.seq.setValue(this.receipt_order_detail.seq);

      if (this.receipt_order_detail != null && this.receipt_order_detail.account_center_fk != null)
        this.account_center_fk.setValue(this.receipt_order_detail.account_center_fk);

        if (this.receipt_order_detail != null && this.receipt_order_detail.account_center != null)
        this.account_center.setValue(this.receipt_order_detail.account_center);


      if (this.receipt_order_detail != null && this.receipt_order_detail.receipt_order_fk != null)
        this.receipt_order_fk.setValue(this.receipt_order_detail.receipt_order_fk);

      if (this.receipt_order_detail != null && this.receipt_order_detail.debtor != null)
        this.debtor.setValue(this.receipt_order_detail.debtor);

      if (this.receipt_order_detail != null && this.receipt_order_detail.creditor != null)
        this.creditor.setValue(this.receipt_order_detail.creditor);

      if (this.receipt_order_detail != null && this.receipt_order_detail.accounts_tree_fk != null)
        this.accounts_tree_fk.setValue(this.receipt_order_detail.accounts_tree_fk);

        if (this.receipt_order_detail != null && this.receipt_order_detail.accounts_tree != null)
        this.accounts_tree.setValue(this.receipt_order_detail.accounts_tree);


      if (this.receipt_order_detail != null && this.receipt_order_detail.account_notice != null)
        this.account_notice.setValue(this.receipt_order_detail.account_notice);
  ...
  getValue() {
    if (this.receipt_order_detail != null && this.seq.value != null)
      this.receipt_order_detail.seq = this.seq.value;

    if (this.receipt_order_detail != null && this.account_center_fk.value != null)
      this.receipt_order_detail.account_center_fk = this.account_center_fk.value;

    if (this.receipt_order_detail != null && this.receipt_order_fk.value != null)
      this.receipt_order_detail.receipt_order_fk = this.receipt_order_fk.value;

    if (this.receipt_order_detail != null && this.debtor.value != null)
      this.receipt_order_detail.debtor = this.debtor.value;

    if (this.receipt_order_detail != null && this.creditor.value != null)
      this.receipt_order_detail.creditor = this.creditor.value;

    if (this.receipt_order_detail != null && this.accounts_tree_fk.value != null)
      this.receipt_order_detail.accounts_tree_fk = this.accounts_tree_fk.value;

    if (this.receipt_order_detail != null && this.account_notice.value != null)
      this.receipt_order_detail.account_notice = this.account_notice.value;
