...
import { Observable, Subscription, startWith, forkJoin, of, map } from 'rxjs';
...
@Component({
  selector: 'app-receipt-order-list-search',
  templateUrl: './receipt-order-list-search.component.html',
  styleUrls: ['./receipt-order-list-search.component.scss']
})
export class ReceiptOrderListSearchComponent {
