...
import { Component, HostListener, EventEmitter, Inject, Input, Output, SimpleChanges, OnDestroy, OnChanges } from '@angular/core';
...
export class SanadKidAttachmentsComponent implements OnDestroy, OnChanges {
  ...
  _sanad_kid_attachement: sanad_kid_attachement;

  get sanad_kid_attachements(): sanad_kid_attachement {
    return this._sanad_kid_attachement;
  }

  @Input() set sanad_kid_attachements(obj: sanad_kid_attachement) {
    this._sanad_kid_attachement = obj;
  }

  _Subscription!: Subscription;

  Form!: FormGroup;
  attachement_seq!: FormControl<number | null>;
  sanad_kid_fk!: FormControl<number | null>;
  attachement_id!: FormControl<number | null>;
  attachement_date!: FormControl<Date | null>;
  type_fk!: FormControl<number | null>;
  // attachement_type!: FormControl<attachement_type | null>;
  attachement_note!: FormControl<string | null>;
  ...
  public BuildForm() {
    try {
      ...
      this.Form = this.fb.group(
        {
          'attachement_seq': this.attachement_seq = new FormControl<number | null>(null, []),
          ...
          'attachement_date': this.attachement_date = new FormControl<Date | null>(null, []),
          ...
          'attachement_note': this.attachement_note = new FormControl<string | null>(null, []),
        },
      );
  ...
  public SetValue() {
    try {
      ...
      if (this.sanad_kid_attachements != null && this.sanad_kid_attachements?.attachement_seq != null)
        this.attachement_seq.setValue(this.sanad_kid_attachements.attachement_seq);
      ...
      if (this.sanad_kid_attachements != null && this.sanad_kid_attachements.attachement_id != null)
        this.attachement_id.setValue(this.sanad_kid_attachements.attachement_id);

      if (this.sanad_kid_attachements != null && this.sanad_kid_attachements.attachement_date != null) {
        this.attachement_date.setValue(this.sanad_kid_attachements.attachement_date);
        this.attachmentDateDay = moment(this.attachement_date.value).date() + '';
        this.attachmentDateMonth = (moment(this.attachement_date.value).month() + 1) + '';
        this.attachmentDateYear = moment(this.attachement_date.value).year() + '';
      ...
      if (this.sanad_kid_attachements != null && this.sanad_kid_attachements.attachement_note != null)
        this.attachement_note.setValue(this.sanad_kid_attachements.attachement_note);
  ...
  getValue() {
    if (this.sanad_kid_attachements != null && this.attachement_seq.value != null)
      this.sanad_kid_attachements.attachement_seq = this.attachement_seq.value;
    ...
    if (this.sanad_kid_attachements != null && this.attachement_id.value != null)
      this.sanad_kid_attachements.attachement_id = this.attachement_id.value;

    if (this.sanad_kid_attachements != null && this.attachement_date.value != null)
      this.sanad_kid_attachements.attachement_date = this.attachement_date.value;
    ...
    if (this.sanad_kid_attachements != null && this.attachement_note.value != null)
      this.sanad_kid_attachements.attachement_note = this.attachement_note.value;
  ...
  attachmentDateChange(changeSource: string) {
    ...
    if (this.attachmentDateDayIsFilled && this.attachmentDateMonthIsFilled && this.attachmentDateYearIsFilled) {
      this.attachement_date.setValue(moment(this.attachmentDateMonth + '/' + this.attachmentDateDay + '/' + this.attachmentDateYear).set({ hour: 4 }).toDate());
    }
  }
